    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('care_tips', models.TextField(blank=True, help_text='General care instructions and tips for growing this crop', null=True)),
                ('fertilizers', models.TextField(blank=True, help_text='Recommended fertilizers and application guidelines', null=True)),
                ('pesticides', models.TextField(blank=True, help_text='Recommended pesticides and application guidelines', null=True)),
