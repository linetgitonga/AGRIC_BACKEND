...
# UUUUUUUUUUUSERSRRRRRRRRRRRRRRRRRRRSSSSSSSSSSSSSSSSSSS
...
class Command(BaseCommand):
    help = 'Creates 20 test users with profiles'

    def handle(self, *args, **options):
        fake = Faker()
        
        # Define user types distribution
        user_types = {
            'farmer': 8,  # 8 farmers
            'buyer': 5,   # 5 buyers
            'expert': 3,  # 3 experts
            'student': 2, # 2 students
            'admin': 2    # 2 admins
        }
                    ...
                    for i in range(count):
                        ...
                        if user_type == 'farmer':
                            FarmerProfile.objects.create(
                                ...
                                farm_size=random.uniform(1.0, 100.0),
                            ...
                            BuyerProfile.objects.create(
                                ...
                                business_type=random.choice(['Wholesaler', 'Retailer', 'Processor']),
                                phone_number=fake.phone_number(),
                                address=fake.address()
                            )
...
# ADDDDDDUUUUUUUUUUUUUUUUUUUSSSSSSSSSSSSSSSSSSSEEEEEEEERRRRRRRRRRRSSSSSSSSS END 
